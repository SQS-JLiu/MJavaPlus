...
import edu.ecnu.sqslab.mjava.ClassMutantsGenerator;
...
public class MutantsGenPanel extends JPanel 
{
   ...
   JComboBox TypeCB = new JComboBox(new String[]{"Thread File","Generic"});
   ...
   void jbInit()
   {
      ...
      usgeContentP.add(new JLabel(" [3] Select File Type [Default : Generic]"));
      usgeContentP.add(new JLabel(" [4] Push \"Generate\" button"));
      usgeContentP.add(new JLabel(" [5] Wait with endurance. ^_^"));
      ...
      fileNoneB.addMouseListener(new MouseAdapter()
      {
      ...
      fileBP.add(Box.createRigidArea(new Dimension(10, 10)));
      fileBP.add(fileAllB);
      fileAllB.addMouseListener(new MouseAdapter()
      {
         public void mouseClicked(MouseEvent e)
         {
      ...
      JLabel TypeL= new JLabel("File Type:");
      TypeP.add(TypeL);
      TypeP.add(TypeCB);
      TypeCB.setPreferredSize(new Dimension(100,25));
      TypeCB.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e)
         {
            if(TypeCB.getSelectedIndex() == 1){
               MutationSystem.ThreadFile = false;
            }
            else {
               MutationSystem.ThreadFile = true;
            }
      ...
      traditionalNoneB.addMouseListener(new MouseAdapter()
      {
         public void mouseClicked(MouseEvent e)
         {
      ...
      traditionalAllB.addMouseListener(new MouseAdapter()
      {
         public void mouseClicked(MouseEvent e)
         {
      ...
      classNoneB.addMouseListener(new MouseAdapter()
      {
         public void mouseClicked(MouseEvent e)
         {
      ...
      classAllB.addMouseListener(new MouseAdapter()
      {
         public void mouseClicked(MouseEvent e)
         {
   ...
   void runB_mouseClicked(MouseEvent e)
   {
      ...
      //MultiThreadTriggerLog.clearLogFile();
      //MultiThreadTriggerLog.openLogFile();
      MutantsGenerator.initCompilationEnv();
      ...
      //MultiThreadTriggerLog.closeLogFile();
