...
/**
 * <p>
 * Template for viewing method-level mutants: show original source code, source code of the selected mutants, summary of
 * mutants
 * </p>
 * @version 1.0
 */
...
public class TraditionalMutantsViewerPanel extends MutantsViewerPanel {
    ...
    JComboBox methodCB = new JComboBox(new String[] {
        "All Methods"
    });
    ...
    void jbInit() throws Exception {
        ...
        /**
         * summary table: containing the numbers of mutants by each method-level mutation operators along with the total
        ...
        /**
         * show a list of mutants to be selected for viewing -- click on the mutant to display the original source and
         * mutated code
         */
    ...
    void updateContents() {
        try {
            ...
            System.err.println("Error in update() in TraditionalMutantsViewerPanel.java: "+e);
        }
    }
    ...
    String getMethodSignature(String str) {
       ...
       return str.split(MutationSystem.LOG_IDENTIFIER)[2];
    }
    ...
    int getMutatedLineNum(String str) {
        ...
        return ((new Integer(str.split(MutationSystem.LOG_IDENTIFIER)[1])).intValue());
    }
